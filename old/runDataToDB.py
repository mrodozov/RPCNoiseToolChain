...
class DBService(object):
	...
	def insertToDB(self, dataList):
		...
		for data in dataList:
			ins = table.insert().values(runnumber=data['run'], exec_date=data['date'], roll=data['runName'],
										masked_strips=data['maskedStrips'], strips_to_mask=data['stripsToMask'],
										strips_to_unmask=data['stripsToUnmask'], rate_hz=data['noise'], rate_hz_cm2=data['noisyStrips'])
...
class FileReader(object):
	...
	def read(self, fileName):
		...
		for run in contents[1:]:
			...
			runData['runName'] = data[0]
			runData['maskedStrips'] = data[1]
			runData['stripsToMask'] = data[2]
			runData['stripsToUnmask'] = data[3]
			runData['noise'] = data[4]
			runData['noisyStrips'] = data[5]
